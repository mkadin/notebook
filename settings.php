...
/**
 * notebook module admin settings and defaults
 *
 * @package    mod
 * @subpackage notebook
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configmultiselect('notebook/displayoptions',
        'Display Options', '',
        $defaultdisplayoptions, $displayoptions));

    $settings->add(new admin_setting_configselect_with_advanced('notebook/display',
        'Default Display', 'Sets the default display type',
        array('value'=>RESOURCELIB_DISPLAY_AUTO, 'adv'=>false), $displayoptions));
    $settings->add(new admin_setting_configtext_with_advanced('notebook/popupwidth',
        'Pop-Up Width', 'Default Pop-Up Width in Pixels',
        array('value'=>620, 'adv'=>true), PARAM_INT, 7));
    $settings->add(new admin_setting_configtext_with_advanced('notebook/popupheight',
